...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- End of Sidebar -->
                  ...
                  <form action="{{route('adminn.testimonial.update',$images->id)}}" method = "post" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="form-group">
                          <label for="image">Image</label>
                          <input type="file" name = "image" id = "image" value="{{$images->image}}" class="form-control" required>
                        </div>
