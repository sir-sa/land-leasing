...
<div class="hero-wrap js-fullheight" style="background-image: url('{{asset('public/frontend/images/'.$image->image)}}');" data-stellar-background-ratio="0.5">
     ...
     <a href="{{route('adminn.coverimage.edit', $image->id)}}" class = "btn btn-info float-left">Edit</a>
    <div>
