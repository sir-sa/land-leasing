...
<section class="ftco-section bg-light">
      <div class="container">
        <div class="row justify-content-center mb-8 pb-6">
         ...
         <div>
           <a class="nav-link btn btn-success" href="{{url('adminn/blog/create')}}" style="margin-left:82%">Add New Blog </a>
        </div>
              ...
              <div class="col-md-4 d-flex ftco-animate">
                <div class="blog-entry justify-content-end">
                  ...
                  <div class="text p-4 float-right d-block">
                    ...
                    <div>
                     <a href="{{route('adminn.blog.edit', $blog->id)}}" class = "btn btn-info float-left">Edit</a>
                     
                    <form action="{{ url('adminn/blog/'.$blog->id)}}" method="post">
                      @csrf
                      @method('DELETE')
