  ...
  <div id="wrapper">
    ...
    <!-- End of Sidebar -->
        ...
        <div class="container">
                ...
                <div class="container">
                  <form action="{{route('adminn.blog.update',$blogs->id)}}" method = "post" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="form-group">
                          <label for="image">Image</label>
                          <input type="file" name = "image" value="{{asset('public/frontend/images/'.$blogs->image)}}"   id = "image" class="form-control" required>
                        </div>
                        <div class="form-group">
                          <label for="heading">Heading</label>
                          <input type="text" name = "heading" id = "heading" value="{{$blogs->heading}}" class="form-control" required>
                        </div>
                        <div class="form-group">
