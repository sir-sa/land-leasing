      ...
      <div class="container">
        ...
        <div class="row ftco-animate">
          <div class="col-md-12">
              ...
              <form action="{{route('adminn.testimonial.update',$testimonials->id)}}" method = "post" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-group">
                          ...
                          <input type="file" name = "image" id = "image" value="{{$testimonials->image}}" class="form-control" required>
                        </div>
                        <div class="form-group">
                          <label for="name">Name</label>
                          <input type="text" name = "name" id = "name" value="{{$testimonials->name}}" class="form-control" required>
                        </div>
