...
<section class="ftco-section testimony-section">
      <div class="container">
        <div class="row justify-content-center mb-5">
         ...
         <div>
           <a class="nav-link btn btn-success" href="{{url('adminn/testimonial/create')}}" style="margin-left:82%">Add New Testimonial </a>
        </div>
                ...
                <div class="testimony-wrap py-4">
                  <div class="text">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                         <a href="{{route('adminn.testimonial.edit', $testimonial->id)}}" class = "btn btn-info float-left">Edit</a>
                         
                        <form action="{{ url('adminn/testimonial/'.$testimonial->id)}}" method="post">
                          @csrf
                          @method('DELETE')
