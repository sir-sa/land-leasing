...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- End of Sidebar -->
        ...
        <div>
           <a class="nav-link btn btn-success" href="{{url('adminn/posts/create')}}" style="margin-left:82%">Add New Posts </a>
        </div>
        <div class="row">
                         ...
                         <div class="item">
                            <div class="wrap">
                              ...
                              <div class="text text-center px-4">
                                ...
                                <p>{{$post->phone}}</p>
                                <h3>Amenities</h3>
                                <p>{{implode(', ',$post->get()->pluck('amenity')->toArray())}}</p>
                                <h4>Amenities</h4>
                                <p>{{implode(', ',$post->get()->pluck('utility')->toArray())}}</p>
                                 
                               <div class="services-wrap">
                                  <a href="#" class="services-list">Click Here to buy this land
                                  <div class="btn-custom d-flex align-items-center justify-content-center"><span class="ion-ios-arrow-round-forward"></span></div>
                                  </a>
                                  <a href="#" class="services-list">You want to lease this land
                                  <div class="btn-custom d-flex align-items-center justify-content-center"><span class="ion-ios-arrow-round-forward"></span></div>
                                  </a>
                                ...
                                <div>
                                  <a href="{{route('adminn.posts.edit', $post->id)}}" class = "btn btn-info">Edit</a>
                                  <a href="{{route('adminn.posts.show', $post->id)}}" class = "btn btn-success">Learn more</a> 
                                   <form action="{{ url('adminn/posts/'.$post->id)}}" method="post">
                                    @csrf
                                    @method('DELETE')
