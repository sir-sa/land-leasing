  ...
  <div id="wrapper">
    ...
    <!-- End of Sidebar -->
        ...
        <div class="container">
                ...
                <div class="container">
                  <form action="{{route('adminn.posts.store')}}" method = "post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                          <label for="cash">Selling_or_Leasing</label>
                        ...
                        <div class="checkbox">
                          <label>
                              <input type="checkbox" name = "amenity[]" value="hospital"   >Hospital
                          </label>
                        </div>
                        <div class="checkbox">
                          <label>
                              <input type="checkbox" name = "amenity[]" value="school" >School
                          </label>
                        </div>
                        <div class="checkbox">
                          <label>
                              <input type="checkbox" name = "amenity[]" value="market" >Market
                          </label>
                        </div>
                        <div class="checkbox">
                          <label>
                              <input type="checkbox" name = "amenity[]" value="shopping">Shopping Center
                          </label>
                        </div>
                        ...
                        <div class="checkbox">
                          <label>
                              <input type="checkbox" name = "utility[]" value="road">Road
                          </label>
                        </div>
                        <div class="checkbox">
                          <label>
                              <input type="checkbox" name = "utility[]" value="water">Water
                          </label>
                        </div>
                        <div class="checkbox">
                          <label>
                              <input type="checkbox" name = "utility[]" value="water">Electricity
                          </label>
                        </div>
