      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('adminn.posts.index')}}">Posts</a>
            <a class="collapse-item" href="{{route('adminn.blog.index')}}">Blogs</a>
            <a class="collapse-item" href="{{route('adminn.testimonial.index')}}">Testimonials</a>
            <a class="collapse-item" href="{{route('adminn.coverimage.index')}}">cover_image</a>
